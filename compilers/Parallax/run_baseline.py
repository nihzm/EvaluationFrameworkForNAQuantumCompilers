...
def main_loop(algo):
    ...
    if res == None:
        ...
        print(" Architecture specifications are: ")
        print("     AOD Rows: ", AOD_ROWS)
        print("     AOD Cols: ", AOD_COLS)
        print("     Atom Rows: ", arr_width)
        print("     Atom Cols: ", arr_height)
        print("     Rydberg Radius: ", radius)
        """
        ...
        """
        frontiers, move_count, total_max_moved_dist, cz_count, u_count, swap_trap_count, trap_dist, swap_trap_gates, full_instruction_list = na.compile_circuit()
        end_time = time.time()
        ...
        compilation_save(algo_name, arr_width, [frontiers, move_count, total_max_moved_dist, cz_count, u_count, swap_trap_count, trap_dist, runtime, elapsed_time, hrdwr, swap_trap_gates, full_instruction_list], AOD_ROWS)
